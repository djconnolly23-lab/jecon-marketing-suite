  ...
  'Marketer 40': [
    {
      ...
      blocks: [
        ...
        { label: 'Hour 6', task: 'Strategic Alignment', detail: 'Strategic alignment notes for the weekly execution pipeline.' },
      ],
    },
    {
      day: 'Tuesday',
      ...
      blocks: [
        ...
        { label: 'Hour 6', task: 'End-of-Day Handoff', detail: 'Wrapping up the day\u2019s priority items and confirming the execution plan for tomorrow.' },
      ],
    },
    {
      day: 'Wednesday',
      ...
      blocks: [
        ...
        { label: 'Hour 6', task: 'Pipeline Throughput Check', detail: 'Mid-week pipeline throughput check.' },
      ],
    },
    {
      day: 'Thursday',
      ...
      blocks: [
        ...
        { label: 'Hour 6', task: 'End-of-Day Handoff', detail: 'Closing out active threads and confirming Friday\u2019s priority queue.' },
      ],
    },
    {
      day: 'Friday',
      ...
      blocks: [
        ...
        { label: 'Hour 6', task: 'System Diagnostics', detail: 'Final system diagnostics check before the weekend.' },
      ],
    },
    {
      day: 'Saturday',
