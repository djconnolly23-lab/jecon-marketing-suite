...
export const PLATFORM_REGISTRY: PlatformConfig[] = [
  {
    ...
    apiVersion: 'v20.0',
    accountName: 'DAKO Official Page',
    icon: 'Facebook',
    color: '#1877F2',
    badgeBg: 'bg-blue-50 text-blue-700 border-blue-200',
    status: 'connected',
    accountHandle: '@DAKOOfficial',
    connected: true,
  ...
  },
  {
    ...
    apiName: 'Meta Graph API',
    apiVersion: 'v20.0',
    accountName: 'DAKO Global Profile',
    icon: 'Instagram',
    color: '#E4405F',
    badgeBg: 'bg-pink-50 text-pink-700 border-pink-200',
    status: 'connected',
    accountHandle: '@dako_official',
    connected: true,
  ...
  },
  {
    ...
    apiName: 'MDP API',
    apiVersion: '202405',
    accountName: 'DAKO LLC Enterprise Page',
    icon: 'Linkedin',
    color: '#0A66C2',
    badgeBg: 'bg-sky-50 text-sky-800 border-sky-200',
    status: 'action_required',
    accountHandle: 'linkedin.com/company/dako-llc',
    connected: true,
  ...
  },
  {
    ...
    apiName: 'Direct API',
    apiVersion: 'v2',
    accountName: 'DAKO Media Hub',
    icon: 'Video',
    color: '#000000',
    badgeBg: 'bg-slate-900 text-white border-slate-700',
    status: 'connected',
    accountHandle: '@dako_media',
    connected: true,
  ...
  },
  {
    ...
    apiVersion: 'v3',
    accountName: 'DAKO Video Network',
    icon: 'Youtube',
    color: '#FF0000',
    badgeBg: 'bg-red-50 text-red-700 border-red-200',
    status: 'connected',
    accountHandle: '@dako_network',
    connected: true,
    description: 'Automated video distribution for YouTube Shorts and long-form content management.',
    supportedFormats: ['Shorts', 'Long-form Video', 'Community Posts'],
  ...
  },
  {
    ...
    apiName: 'X API v2',
    apiVersion: '2',
    accountName: 'DAKO Official',
    icon: 'Twitter',
    color: '#1DA1F2',
    badgeBg: 'bg-cyan-50 text-cyan-700 border-cyan-200',
    status: 'connected',
    accountHandle: '@DAKO_HQ',
    connected: true,
    description: 'Real-time microblogging, threads dispatch, and automated engagement tracking.',
    supportedFormats: ['Tweets', 'Threads', 'Media Cards'],
  ...
  },
  {
    ...
    apiVersion: 'v1',
    accountName: 'DAKO Threads',
    icon: 'MessageSquare',
    color: '#000000',
    badgeBg: 'bg-zinc-100 text-zinc-900 border-zinc-300',
    status: 'connected',
    accountHandle: '@dako_threads',
    connected: true,
    description: 'Text-based conversation publishing and community management via Threads API.',
    supportedFormats: ['Text Posts', 'Image Carousels', 'Replies'],
  ...
  },
  {
    ...
    apiVersion: 'v5',
    accountName: 'DAKO Creative Pins',
    icon: 'Bookmark',
    color: '#E60023',
    badgeBg: 'bg-red-50 text-red-800 border-red-300',
    status: 'connected',
    accountHandle: '@dako_pins',
    connected: true,
    description: 'Visual bookmarking and idea pin distribution for eCommerce and discovery.',
    supportedFormats: ['Idea Pins', 'Standard Pins', 'Video Pins'],
  ...
  },
  {
    ...
    apiName: 'AT Protocol',
    apiVersion: 'v1',
    accountName: 'DAKO Social',
    icon: 'Cloud',
    color: '#0085FF',
    badgeBg: 'bg-blue-50 text-blue-800 border-blue-200',
    status: 'connected',
    accountHandle: '@dako.bsky.social',
    connected: true,
    description: 'Decentralized social network publishing and feed management.',
    supportedFormats: ['Short Posts', 'Links', 'Images'],
    scopes: ['atproto_publish', 'atproto_session'],
    tokenExpiryDays: 365,
    tokenExpiresAt: '2027-09-01T00:00:00Z',
    canCreatePost: true,
    canAutomateDm: false,
  ...
  },
  {
    ...
    apiName: 'Reddit API',
    apiVersion: 'v1',
    accountName: 'u/dako_official',
    icon: 'MessageCircle',
    color: '#FF4500',
    badgeBg: 'bg-orange-50 text-orange-700 border-orange-200',
    status: 'connected',
    accountHandle: 'u/dako_official',
    connected: true,
    description: 'Subreddit engagement tracking and community content management.',
    supportedFormats: ['Text Posts', 'Link Shares', 'Image Posts'],
    scopes: ['submit', 'read', 'mysubreddits'],
    tokenExpiryDays: 60,
    tokenExpiresAt: '2026-11-01T00:00:00Z',
    canCreatePost: true,
    canAutomateDm: false,
  ...
  },
  {
    ...
    apiName: 'GBP API',
    apiVersion: 'v1',
    accountName: 'DAKO Headquarters',
    icon: 'MapPin',
    color: '#4285F4',
    badgeBg: 'bg-blue-50 text-blue-600 border-blue-200',
    status: 'connected',
    accountHandle: 'DAKO HQ',
    connected: true,
    description: 'Local search visibility, updates, offers, and review response management.',
    supportedFormats: ['Business Posts', 'Offers', 'Events'],
  ...
  },
  {
    ...
    apiVersion: 'v7',
    accountName: 'DAKO Broadcast',
    icon: 'Send',
    color: '#229ED9',
    badgeBg: 'bg-sky-50 text-sky-600 border-sky-200',
    status: 'connected',
    accountHandle: '@dako_broadcast',
    connected: true,
    description: 'Instant broadcast messaging and automated subscriber community updates.',
    supportedFormats: ['Broadcast Messages', 'Polls', 'Files'],
    scopes: ['bot_messages', 'channel_post'],
    tokenExpiryDays: 365,
    tokenExpiresAt: '2027-09-01T00:00:00Z',
    canCreatePost: true,
    canAutomateDm: true,
  ...
  },
  {
    ...
    apiVersion: 'v1',
    accountName: 'DAKO Snap',
    icon: 'Camera',
    color: '#FFFC00',
    badgeBg: 'bg-yellow-50 text-yellow-800 border-yellow-200',
    status: 'connected',
    accountHandle: '@dako_snap',
    connected: true,
    description: 'Vertical video distribution for Snapchat Spotlight and story highlights.',
    supportedFormats: ['Vertical Video', 'Spotlight Clips'],
    scopes: ['snapchat-creative-kit', 'snapchat-profile-api'],
    tokenExpiryDays: 90,
    tokenExpiresAt: '2026-12-01T00:00:00Z',
    canCreatePost: true,
    canAutomateDm: false,
  ...
  },
  {
    ...
    accountName: 'DAKO Official Truth Account',
    icon: 'Share2',
    color: '#7C3AED',
    badgeBg: 'bg-purple-50 text-purple-700 border-purple-200',
    status: 'manual_mode',
    accountHandle: '@DAKOLLC',
    connected: false,
...
export const INITIAL_POST_DRAFTS: PostDraft[] = [
  ...
  },
  {
    ...
    hashtags: ['#CaseStudy', '#Enterprise', '#CustomerSuccess', '#B2B', '#DAKO'],
    aspectRatio: '1:1',
    status: 'published',
...
export const INITIAL_CONVERSATIONS: CustomerConversation[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm-2',
        sender: 'bot',
        text: 'Thank you for reaching out to DAKO LLC! Your request has been routed to our enterprise team.',
        timestamp: '10:15 AM'
      }
    ]
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm-4',
        sender: 'bot',
        text: 'Hi Elena! Thanks for your interest in the DAKO Q3 Leadership Cohort. Here is your direct access link: https://dako.ai/q3-masterclass. Let us know if you have any questions!',
        timestamp: '09:42 AM'
      },
      {
        id: 'm-5',
  ...
  },
  {
    ...
    receivedAt: '08:50 AM',
    suggestedReply: 'Hi David, I apologize for the double billing issue. I am reviewing transaction #DK-8842 right now and will process an immediate credit refund to your card on file.',
    messages: [
      {
        id: 'm-6',
        sender: 'customer',
        text: 'Hi, our invoice was billed twice for the quarterly briefing subscription. Can someone please check transaction #DK-8842 and issue a credit? This is blocking our finance close.',
        timestamp: '08:50 AM'
      },
      {
        id: 'm-7',
